...
{
	if (pos == Consensus::DEPLOYMENT_SEGWIT) return THRESHOLD_ACTIVE;
	if (pos == Consensus::DEPLOYMENT_CSV) return THRESHOLD_ACTIVE;
	if (pos == Consensus::DEPLOYMENT_TESTDUMMY) return THRESHOLD_ACTIVE;
